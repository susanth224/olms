                     ...
                     <div class="row-fluid">
                        ...
                        <div  id="block_bg" class="block">
                            ...
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><i class="icon-reorder icon-large"></i><?php //echo $branch ?> Outing Records</div>
                                <div class="muted pull-right">
									Outings Sanctioned till now  <span class="badge badge-info"><?php  $todaydate=date("d m Y");$wai='wait';
											$res=mysql_query("SELECT count(*) FROM outing WHERE  `permission`='granted'");
                            ...
                            <div class="block-content collapse in">
								...
								<h2 id="noch"><?php //echo $branch ?> Outing Records</h2>
