	...
	<center>
		<img src="images/logo.png" id="logo">
                    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
                        ...
                        <li class="active"><a href="sanctioned_outings.php"><i class="icon-chevron-right icon-large"></i><i class="icon-ok icon-large"></i> Sanctioned Outings</a></li>
...
echo '
	<div class="alert alert-error fade in">
		    ...
		    <a href="sanctioned_outings.php" class="btn btn-success" >Close</a>
	</div>
';
}
}
?>
                        ...
                        <div  id="block_bg" class="block">
                            ...
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><i class="icon-reorder icon-large"></i> <?php //echo $branch ?> Sanctioned Outings List</div>
                                <div class="muted pull-right">
									Outings Sanctioned Today <span class="badge badge-info"><?php  $todaydate=date("d m Y");$wai='wait';
											$res=mysql_query("SELECT count(*) FROM outing WHERE  `permission`='granted' and adate='$todaydate'");
											while($row=mysql_fetch_array($res)){$tdtl=$row[0];} echo $tdtl; ?></span>
								</div>
                            </div>
                            <div class="block-content collapse in">
								<div class="span13" id="studentTableDiv">
								<h2 id="noch"><?php //echo $branch ?> Sanctioned Outings List</h2>
									<?php include('sanction_out_table.php'); ?>
                                </div>
                            </div>
                        </div>
                        <!-- /block -->
