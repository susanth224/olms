...
?>
                        ...
                        <div  id="block_bg" class="block">
                            ...
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><i class="icon-reorder icon-large"></i><?php //echo $branch ?> Pending Leaves List</div>
                                <div class="muted pull-right">
									Pending Leaves  <span class="badge badge-info"><?php  $todaydate=date("d m Y");$wai='wait';
											$res=mysql_query("SELECT count(*) FROM leaves WHERE  `permission`='$wai'");
