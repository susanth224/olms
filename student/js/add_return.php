...
if(mysql_num_rows($a)>0)
{
	...
	for($i=0;$i<$npmks;$i++)
	{
		if($upmkeys[$i]!="")
		{
			...
			function returned()
			{
				var return_id_key="<?php echo $kkey;?>";
				var type="<?php echo $type;?>"
				$.post("return_time.php",{okey:return_id_key,type:type},function(data)
				{
					$("#san_popup").html(data);
				});
			}
			...
			<td>
				...
				<div  class="divs" style="padding:10px;width:130px;">
					...
					<ul>
						...
						<?php
						if($type=="leaves")
								echo '<li>has to come on:</li><li>'.$id_out_det['idate'].'</li>'
						?>
					</ul>
					<p>
				<input type="submit" class="submit" value="returned" onclick="returned()">
				</p>
				</div>
