                        ...
                        <div  id="block_bg" class="block">
                            ...
                            <div class="navbar navbar-inner block-header">
                                ...
                                <div class="muted pull-right">
									OUTSIDE CAMPUS BY LEAVE  <span class="badge badge-info"><?php  $todaydate=date("d m Y");$wai='wait';
											$res=mysql_query("SELECT count(*) FROM leaves WHERE  ogtime!='--' AND permission='granted' AND ictime='--'");
