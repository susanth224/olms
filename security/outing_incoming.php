	...
	<center>
		<img src="images/logo.png" id="logo">
                    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
                        ...
                        <li class="active"><a href="outing_incoming.php"><i class="icon-chevron-right icon-large"></i><i class="icon-circle-arrow-down icon-large"></i>INCOMING</a></li>
...
echo '
	<div class="alert alert-success fade in">
		    ...
		    <a href="outing_incoming.php" class="btn btn-success" >Close</a>
	</div>
';
}
}
                        ...
                        <div  id="block_bg" class="block">
                            ...
                            <div class="navbar navbar-inner block-header">
                                ...
                                <div class="muted pull-right">
									Not Reported  <span class="badge badge-info"><?php  $todaydate=date("d m Y");$wai='wait';
											$res=mysql_query("SELECT count(*) FROM outing WHERE  `ogdate`!='--' AND `icdate`='--' AND `permission`='granted'");
                            ...
                            <div class="block-content collapse in">
								...
								<h2 id="noch">IIIT NUZ Students List</h2>
									<?php include('outing_table_incoming.php'); ?>
                                </div>
                            </div>
                        </div>
                        <!-- /block -->
