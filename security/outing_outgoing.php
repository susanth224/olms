	...
	<center>
		<img src="images/logo.png" id="logo">
                   <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
						...
						<li class="active"><a href="outing_outgoing.php"><i class="icon-chevron-right icon-large"></i><i class="icon-circle-arrow-up icon-large"></i>OUTGOING</a></li>
...
echo '
	<div class="alert alert-success fade in">
		    ...
		    <p>Successfully Left.</p>
		    <a href="outing_outgoing.php" class="btn btn-success" >Close</a>
	</div>
';
}
}
                            ...
                            <div class="navbar navbar-inner block-header">
                                ...
                                <div class="muted pull-right">
									Sanctioned  <span class="badge badge-info"><?php  $todaydate=date("d m Y");$wai='wait';
											$res=mysql_query("SELECT count(*) FROM outing WHERE `ogdate`='--' AND `permission`='granted'");
