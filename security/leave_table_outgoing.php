	...
	<?php include('modal_delete.php'); ?>
		...
		<tbody>
		<?php
					$res=mysql_query("select * from leaves where permission='granted' and ogtime='--';");
							...
							{		echo "<tr>"?>
								...
								<td class="empty">
		<a data-placement="top" title="Click to Approve" id="approve<?php echo $row['sno']; ?>" href='log.php?sno=<?php echo "".$row['sno']."";?>' class="btn btn-success"><i class="icon-ok icon-large"></i>Left</a></a>
