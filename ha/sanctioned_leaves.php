...
?>
                        ...
                        <div  id="block_bg" class="block">
                            ...
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><i class="icon-reorder icon-large"></i> <?php echo $block ?> Sanctioned Leaves List</div>
                            ...
                            <div class="block-content collapse in">
								...
								<h2 id="noch"><?php echo $block ?> Sanctioned Leaves List</h2>
