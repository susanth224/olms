	...
	<?php include('modal_delete.php'); ?>
		...
		<?php
							$cdate = date("d m Y");
					$res=mysql_query("SELECT * FROM leaves WHERE block='".$block."' AND permission='refuse' AND adate='$cdate' ORDER BY sno ASC LIMIT 30");
		...
		<a data-placement="top" title="Click to Approve" id="approve<?php echo $row['sno']; ?>" href='approve_ref_leaves.php?sno=<?php echo "".$row['sno']."";?>' class="btn btn-success"><i class="icon-ok icon-large"></i>Approve</a></a>
