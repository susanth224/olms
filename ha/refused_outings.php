...
if(isset($_GET['#hi']))
{
echo '<meta http-equiv="refresh" content="1,12.php">';
}
?>
	...
	<center>
		<img src="images/logo.png" id="logo">
                    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
                        ...
                        <li class="active"><a href="refused_outings.php"><i class="icon-chevron-right icon-large"></i><i class="icon-remove icon-large"></i> Refused Outings</a></li>
...
echo '
	<div class="alert alert-success fade in">
		    ...
		    <a href="refused_outings.php" class="btn btn-success" >Close</a>
	</div>
';
}
}
?>
                        ...
                        <div  id="block_bg" class="block">
                            ...
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><i class="icon-reorder icon-large"></i><?php echo $block ?> Refused Outings List</div>
                                <div class="muted pull-right">
									Outings Refused  <span class="badge badge-info"><?php  $todaydate=date("d m Y");$wai='wait';
									$res=mysql_query("SELECT count(*) FROM outing WHERE `block`='$block'  AND `permission`='refuse'");
									while($row=mysql_fetch_array($res)){$tdtl=$row[0];} echo $tdtl; ?></span>
								</div>
                            </div>
                            <div class="block-content collapse in">
								<div class="span13" id="studentTableDiv">
								<h2 id="noch"><?php echo $block ?> Refused Outings List</h2>
									<?php include('refused_out_table.php'); ?>
                                </div>
                            </div>
                        </div>
                        <!-- /block -->
