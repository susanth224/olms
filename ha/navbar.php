    ...
    <div class="navbar navbar-fixed-top navbar-inverse" >
            <div class="navbar-inner" >
                <div class="container-fluid">
                    ...
                    <span class="brand" href="#">IIIT NUZ Online Leave Management System - <?php echo $block; ?> Block</span>
...
<li><a   role="button" style="color:white;" tabindex="-1" href="student_details.php"><i class="icon-user icon-large"></i>&nbsp;<?php echo $block; ?> Students</a></li>
 ...
 <li class="divider"></li>
                   ...
                   <li class="dropdown">
                                <a href="#" id="name123" role="button" class="dropdown-toggle" data-toggle="dropdown"> <i class="icon-user icon-large"></i><?php echo $block  ?> <i class="caret"></i></a>
                                <ul class="dropdown-menu">
									<!--  <li><a class="jkl" tabindex="-1" href="#">Profile</a></li> -->
                                    <li class="divider"></li>
