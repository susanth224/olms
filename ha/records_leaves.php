	...
	<center>
		<img src="images/logo.png" id="logo">
                    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
						...
						<li class="active"><a href="records_leaves.php"><i class="icon-chevron-right icon-large"></i><i class="icon-bar-chart icon-large"></i> Leave Records</a></li>
                     ...
                     <div class="row-fluid">
                        ...
                        <div  id="block_bg" class="block">
                            ...
                            <div class="navbar navbar-inner block-header">
                                ...
                                <div class="muted pull-left"><i class="icon-reorder icon-large"></i><?php echo $block ?> Leave Records</div>
                                
                                <div class="muted pull-right">
									
									Leaves Sanctioned till now  <span class="badge badge-info"><?php  $todaydate=date("d m Y");$wai='wait';
											$res=mysql_query("SELECT count(*) FROM leaves WHERE `block`='$block' AND `permission`='granted'");
											while($row=mysql_fetch_array($res)){$tdtl=$row[0];} echo $tdtl; ?></span>
								</div>
                            </div>
                            <h2 id="noch"><?php echo $block ?> Leave Records</h2>
                            	<?php include('leave_rcrd.php'); ?>
