...
if((isset($_POST["user"])) & (isset($_POST["password"])))
{
	...
	$result=mysql_query("SELECT * FROM faculty WHERE username='".$user."' AND password='".$passwd."' ");
	$check=1;
	while($row=mysql_fetch_array($result)){$check=0;$_SESSION["hod"]=$user;$_SESSION["branch"]=$row['branch'];}
	if($check==1){header('Location: index.php?status=failed');}
...
<div class="container-fluid">
            <div class="row-fluid">
			<div class="span3" id="sidebar" style="width:20%;border:2px solid black;padding: 3px 13px 15px 3px;">
	...
	<li><a href="student_details.php"><i class="icon-chevron-right icon-large"></i><i class="icon-user icon-large"></i> Student Details</a></li>
				...
				<br>
                <div class="span4" id="" style="padding-left:3%;">
									    											 																<?php 
                        ...
                        <div  id="block_bg" class="block">
                            ...
                            <div class="navbar navbar-inner block-header">
                                ...
                                <div class="muted pull-right">
									 <?php echo "<span style='color:black;font-weight:bold;'>TODAY OUTING REQUESTS</span>"; ?>
								</div>
                            </div>
